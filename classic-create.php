...
$unik = date('Hs');
$unik2 = date('s');
$unik3 = substr(str_shuffle(1234567890), 0, 3);
$merchantRef  = 'ZEP' . $unik . $unik2 . $unik3;
...
<html lang="en">
 <head> 
  ...
  <!-- Primary Meta Tags --> 
  <title>#UNPAID - Rp 24.240 - 86 (78+8) Diamonds</title> 
  <meta name="title" content="#UNPAID - Rp 24.240 - 86 (78+8) Diamonds"> 
  <meta name="description" content="Cari paling mudah Top Up Diamond di Papipum.com dengan Harga yang Terjangkau"> 
  <!-- Open Graph / Facebook --> 
  <meta property="og:type" content="website"> 
  <meta property="og:url" content="https://papipum.com/c/WUDKC574ML"> 
  <meta property="og:title" content="#UNPAID - Rp 24.240 - 86 (78+8) Diamonds"> 
  <meta property="og:description" content="Cari paling mudah Top Up Diamond di Papipum.com dengan Harga yang Terjangkau"> 
  <meta property="og:image" content="https://papipum.com//assets/logo_bg.png"> 
  <!-- Twitter --> 
  <meta property="twitter:card" content="summary_large_image"> 
  <meta property="twitter:url" content="https://papipum.com/c/WUDKC574ML"> 
  <meta property="twitter:title" content="#UNPAID - Rp 24.240 - 86 (78+8) Diamonds"> 
  <meta property="twitter:description" content="Cari paling mudah Top Up Diamond di Papipum.com dengan Harga yang Terjangkau"> 
  <meta property="twitter:image" content="https://papipum.com//assets/logo_bg.png"> 
  <!--====== Favicon Icon ======--> 
  <link rel="shortcut icon" href="https://papipum.com/assets/logo.png" type="image/svg"> 
  <link rel="stylesheet" type="text/css" href="https://papipum.com/assets/template/bootstrap.css"> 
  <link rel="stylesheet" type="text/css" href="https://papipum.com/assets/template/bootstrap-icons.css"> 
  <link rel="stylesheet" type="text/css" href="https://papipum.com/assets/template/select2.min.css"> 
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.7.2/font/bootstrap-icons.css"> 
  <link rel="stylesheet" href="https://papipum.com/assets/wa/venom-button.min.css"> 
  <link rel="preconnect" href="https://fonts.gstatic.com"> 
  <link href="https://papipum.com/cloudme.fonts.googleapis.com/css2?family=Inter:wght@500;600;700;800&amp;family=Roboto:wght@400;500;700&amp;display=swap" rel="stylesheet"> 
 ...
 <body class="theme-light" id="bodyhtml" style="background-image:url('https://i.ibb.co/yn6fgyg/Be-Funky-design-21.jpg')"> 
  ...
  <div id="page"> 
   ...
   <div id="footer-bar" class="footer-bar footer-bar-detached"> 
    <a class="" href="https://papipum.com/invoice"> <i class="bi bi-search font-16"></i> <span>Check</span> </a> 
    <a href="https://papipum.com/spin-berhadiah"> <i class="bi bi-gift font-16 rise-shake"></i> <span>Hadiah</span> </a> 
    <a class="active-nav" href="https://papipum.com/"> <i class="bi bi-house-fill font-16"></i> <span>Home</span> </a> 
    <a href="https://papipum.com/tambang-diamond" class=""> <i class="bi bi-gem font-16"></i> <span>Gratis</span> </a> 
    <a class="" href="https://papipum.com/users"> <i class="bi bi-person font-16"></i> <span>Masuk</span> </a> 
   </div> 
    ...
    <div> 
     ...
     <div class="menu-list"> 
      <div class="card card-style rounded-m p-3 py-2 mb-0"> 
       ...
       <a href="https://papipum.com/jual-beli-akun" id="nav-mails"> <i class="gradient-red shadow-bg shadow-bg-xs bi bi-controller"></i> <span>Jual / Beli Akun</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://www.google.com/maps/uv?pb=!1s0x2dd663f196095f87%3A0x138e73226fcdb6e9!5spapipum.com!15sCgIgAQ&amp;imagekey=!1e10!2sAF1QipPCEgAvT-Vij_8uiNvs3JTVorXU-egXFELQ9AbN" target="_blank" id="nav-mails"> <i class="gradient-yellow shadow-bg shadow-bg-xs bi bi-shop"></i> <span>Offline Store</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/testimoni" id="nav-mails"> <i style="background-color: #4267B2" class="shadow-bg shadow-bg-xs bi bi-cart-fill"></i> <span>Testimoni</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://play.google.com/store/apps/details?id=com.papipum_com" target="_blank" id="nav-mails"> <i class="gradient-blue shadow-bg shadow-bg-xs bi bi-phone-fill"></i> <span>Google Playstore</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/faq" id="nav-mails"> <i class="gradient-orange shadow-bg shadow-bg-xs bi bi-chat-dots"></i> <span>FAQ</span> <i class="bi bi-chevron-right"></i> </a> 
      </div> 
     </div> 
     <span class="menu-divider mt-4">Kalkulator</span> 
     <div class="menu-list"> 
      <div class="card card-style rounded-m p-3 py-2 mb-0"> 
       <a href="https://papipum.com/kalkulator-joki" id="nav-mails"> <i style="background-color: #4267B2" class="shadow-bg shadow-bg-xs bi bi-calculator"></i> <span>Kalkulator Joki</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/hitung-wr" id="nav-mails"> <i class="gradient-green shadow-bg shadow-bg-xs bi bi-calculator"></i> <span>Hitung WR</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/hp-magic-wheel" id="nav-mails"> <i class="gradient-blue shadow-bg shadow-bg-xs bi bi-calculator"></i> <span>HP Magic Wheel</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/hp-zodiac" id="nav-mails"> <i class="gradient-orange shadow-bg shadow-bg-xs bi bi-calculator"></i> <span>HP Zodiac</span> <i class="bi bi-chevron-right"></i> </a> 
      </div> 
     </div> 
     <span class="menu-divider mt-4">Bantuan &amp; Sosmed</span> 
     <div class="menu-list" style="margin-bottom: 50px"> 
      <div class="card card-style rounded-m p-3 py-2 mb-0"> 
       <a href="https://www.instagram.com/papipum_com/"> <i style="background-color: #e95950" class="shadow-bg shadow-bg-xs bi bi-instagram"></i> <span>Instagram</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://www.facebook.com/papipumcom"> <i style="background-color: #4267B2" class="shadow-bg shadow-bg-xs bi bi-facebook"></i> <span>Facebook</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://www.tiktok.com/@papipum_com"> <i style="background-color: #000" class="shadow-bg shadow-bg-xs bi bi-tiktok"></i> <span>TikTok</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/terms-conditions"> <i class="gradient-green shadow-bg shadow-bg-xs bi bi-clipboard-check"></i> <span>Terms &amp; Conditions</span> <i class="bi bi-chevron-right"></i> </a> 
       <a href="https://papipum.com/privacy-policy"> <i class="gradient-orange shadow-bg shadow-bg-xs bi bi-clipboard-check"></i> <span>Privacy Policy</span> <i class="bi bi-chevron-right"></i> </a> 
      </div> 
     </div> 
    </div> 
   </div> 
   ...
   <div class="page-content header-clear-medium"> 
    <div class="card card-style mb-3"> 
     <div class="content"> 
      <div class="d-flex"> 
       <h5>💎 86 (78+8) Diamonds</h5> 
      </div> 
      <table class="table color-theme mb-2 mt-2"> 
       <tbody>
        <tr> 
         <td>ID Transaksi</td> 
         <td>: WUDKC574ML <span class="badge bg-primary ms-1" onclick="copy('WUDKC574ML')" data-toast="done">Salin</span></td> 
        </tr> 
        <tr> 
         <td>Tgl. Pembelian</td> 
         <td>: March 12, 2023, 2:06 am</td> 
        </tr> 
        <tr> 
         <td>ID Akun</td> 
         <td>: 517282183 (8071)</td> 
        </tr> 
        <tr id="diskon_tr"> 
         <td>Total Pembelian</td> 
         <th class="color-highlight">: Rp 24.240</th> 
        </tr> 
       </tbody>
      </table> 
     </div> 
    ...
    <div class="card card-style"> 
     <div class="content"> 
      <div class="list-group list-custom list-group-m mb-2"> 
       <a class="list-group-item" href="#" data-toast="done" aria-expanded="true"> <img src="https://assets.tripay.co.id/upload/payment-icon/8WQ3APST5s1579461828.png" style="width: 70px; height: 20px; margin-right: 20px;"> 
        <div> 
         <strong style="margin-bottom: 3px;"> BRI Virtual Account </strong> 
         <span> Dicek Otomatis </span> 
        </div> </a> 
      </div> 
     </div> 
    </div> 
    ...
    <div class="row mt-4" style="margin-right: 30px; margin-left: 30px; margin-bottom: 50px;"> 
     ...
     <center>
      ...
      <b class="color-highlight"><a href="https://papipum.com/terms-conditions" target="_blank">Syarat dan Ketentuan</a></b> dan juga 
      <b class="color-highlight"><a href="https://papipum.com/privacy-policy" target="_blank">Kebijakan Privasi</a></b> Papipum.com. 
     </center> 
    </div> 
   </div> 
   <script>
    $("#btn_submit").on('click', e => {
		...
		if(payment === ''){
    		...
    		location = 'https://papipum.com/change-payment/WUDKC574ML/' + payment
		}
	})
	...
	function next(){
	    ...
	    location = 'https://papipum.com/confirm-payment/WUDKC574ML';
	}
	...
	const qrCode = new QRCodeStyling(
        {
          ...
          image: "https://papipum.com/assets/logo_shadow.png",
          dotsOptionsHelper: {
            colorType: {
              single: true,
              gradient: false
  ...
  <script src="https://papipum.com/assets/template/bootstrap.min.js"></script> 
  <script src="https://papipum.com/assets/template/custom.js"></script> 
  <script src="https://papipum.com/assets/template/select2.min.js"></script> 
  <script src="https://papipum.com/assets/wa/venom-button.min.js"></script> 
  ...
  <script src="https://papipum.com/assets/template/exp.js"></script> 
  <script>
